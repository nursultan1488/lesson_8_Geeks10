...
public class RPG_Game {
    ...
    public static void startGame() {
        ...
        Bomber bomber = new Bomber("Tik", 300, 15);
        Ludoman ludoman = new Ludoman("Supercell",400, 10)
        {
            @Override
        ...
        Hero[] heroes = {warrior1, doc, warrior2, magic, berserk, assistant,bomber,ludoman};
